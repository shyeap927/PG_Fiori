...
jQuery.sap.require("test.test.integration.NavigationJourneyPhone");
jQuery.sap.require("test.test.integration.NotFoundJourneyPhone");
jQuery.sap.require("test.test.integration.BusyJourneyPhone");